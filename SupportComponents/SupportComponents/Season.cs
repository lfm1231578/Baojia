   ...
   public class Season
    {
        ...
        {
            string WeekENG = datetime.DayOfWeek.ToString();
            string return_value = "";
            switch (WeekENG)
            {
                case "Monday":
        ...
        /// <param name="dtDay">公历日期</param> 
        /// <returns></returns> 
        public static DateTime GetLunarCalendarToDatetime(DateTime dtDay)
        {
            string sYear = dtDay.Year.ToString();
            string sMonth = dtDay.Month.ToString();
            string sDay = dtDay.Day.ToString();
            ...
            try
            {
                ...
                try
                {
                    return Convert.ToDateTime(year + "-" + month + "-" + 28);
                }
                catch {
