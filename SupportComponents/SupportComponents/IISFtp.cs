   ...
   public class IISFtp
    {
        ...
        /// </summary>
       public void UploadByFtp(string ftpAddress, string filePath, string name, string _username,string _password)
        {
            FileStream fs = null;
            Stream stream = null;
            string uri = string.Empty;
        ...
        /// </summary>
       public void UploadByFtp(string ftpAddress, MemoryStream fileStream, string fileName, string _username, string _password)
        {
            string uri = string.Empty;
            if (ftpAddress.Contains("ftp://"))
                uri = ftpAddress;
        ...
        /// </summary>
       public void DeleteByFtp(string ftpAddress, string fileName, string _username, string _password)
        {
            string uri = string.Empty;
            if (ftpAddress.Contains("ftp://"))
       ...
       public void DownloadByFtp(string uri, MemoryStream stream, bool isInternalAuth, string _username, string _password)
        {
            if (!uri.Contains("ftp://"))
                uri = "ftp://" + uri;
        ...
        /// </summary>
       public void CreateDirectory(string ftpAddress, string directory, string _username, string _password)
        {
            string uri = string.Empty;
            if (ftpAddress.Contains("ftp://"))
                uri = ftpAddress;
       ...
       public int RemoveDirectory(string ftpAddress, string directory, string _username, string _password)
        {
            int result;
            string uri = string.Empty;
            if (ftpAddress.Contains("ftp://"))
       ...
       public string[] GetFileList(string ftpAddress, string directory, bool isInternalAuth, string _username, string _password)
        {
            string uri = string.Empty;
       ...
       public int IsExist(string ftpAddress, string directory, string _username, string _password)
        {
            string uri = string.Empty;
            int result;
            if (ftpAddress.Contains("ftp://"))
